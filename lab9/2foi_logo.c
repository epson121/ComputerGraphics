...
void kvadar(double ax, double ay, double az) {
  ...
  glBegin(GL_QUAD_STRIP);
    ...
    glTexCoord2d(1.0, 1.0); glVertex3d(ax, 0.0, az);
    glTexCoord2d(1.0, 0.0); glVertex3d(ax, 0.0, 0.0);
    glTexCoord2d(0.0, 1.0); glVertex3d(ax, 0.0, az);
    glTexCoord2d(0.0, 0.0); glVertex3d(ax, 0.0, 0.0);
    glTexCoord2d(1.0, 1.0); glVertex3d(ax, ay, az);
    glTexCoord2d(1.0, 0.0); glVertex3d(ax, ay, 0.0);
    glTexCoord2d(0.0, 1.0); glVertex3d(ax, ay, az);
    glTexCoord2d(0.0, 0.0); glVertex3d(ax, ay, 0);
    glTexCoord2d(1.0, 1.0); glVertex3d(0.0, ay, az);
    glTexCoord2d(1.0, 0.0); glVertex3d(0.0, ay, 0.0);
    glTexCoord2d(0.0, 1.0); glVertex3d(0.0, ay, az);
    glTexCoord2d(0.0, 0.0); glVertex3d(0.0, ay, 0.0);
    glTexCoord2d(1.0, 1.0); glVertex3d(0.0, 0.0, az);
  ...
  glBegin(GL_QUADS);
    ...
    glVertex3d(0.0, ay, 0.0);
    glVertex3d(ax, ay, 0.0);
    glVertex3d(ax, 0.0, 0.0);
    glVertex3d(0.0, 0.0, az);
    glVertex3d(ax, 0.0, az);
    glVertex3d(ax, ay, az);
    glVertex3d(0.0, ay, az);
  glEnd();
